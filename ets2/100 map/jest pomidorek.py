...
combined_output_file_path = "combined_output_results2.txt"
        ...
        for index, file_path in enumerate(file_paths):
            with open(file_path, 'r') as input_file:
                for line in input_file:
                    combined_output_file.write(f"discovered_items[{lol}]: {line}")
                    lol += 1
...
def process_directory(directory_path):
    ...
    combine_and_prefix_files([output_file_path_type_3, output_file_path_type_4_bit_5_set], combined_output_file_path)
